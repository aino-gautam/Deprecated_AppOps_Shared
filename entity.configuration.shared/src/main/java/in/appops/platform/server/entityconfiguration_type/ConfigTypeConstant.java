...
public class ConfigTypeConstant {
	...
	public static final String	CONFIGTYPEID		= "configtypeId";
	public static final String	ISIMMUTABLE			= "isImmutable";
	public static final String	SUPERTYPEID			= "supertypeId";
	...
	public static final String	CLIENTQNAME			= "clientqname";
